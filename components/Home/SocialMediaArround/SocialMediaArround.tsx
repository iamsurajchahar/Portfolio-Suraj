      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            {/* Github Icon */}
            <IconClickableWithAnimation Icon={GithubIcon} href={"https://github.com/iamsurajchahar"} />
            {/* Linkedin icon */}
            <IconClickableWithAnimation Icon={LinkedinIcon} href={"https://www.linkedin.com/in/imsurajchahar/"} />
            {/* Instagram Icon */}
            {/* <IconClickableWithAnimation Icon={InstagramIcon} href={"https://www.instagram.com/xredme/"} /> */}
            {/* Youtube Icon */}
            <IconClickableWithAnimation Icon={YoutubeIcon} href={"https://www.youtube.com/channel/UC-n3Fr7c0WoHd8CUPn4CQzw"} />
          </div>
      ...
      >
        <div className="flex flex-col space-y-24 justify-center items-center">
          ...
          <motion.div
            ...
            className=""
          >
            <a href="mailto:contact.chahar@gmail.com" target={"_blank"} rel="noreferrer">
              <span className=" font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer">
                chahar<span className="text-AAsecondary">.</span>contact<span className="text-AAsecondary">@gmail.</span>com
              </span>
            </a>
          </motion.div>

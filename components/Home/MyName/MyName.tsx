  ...
  return (
    ...
    >
      ...
      >
        ...
        digital experiences. My current area of focus is in the <span className="text-AAsecondary">MERN stack and DevOps</span>,
        where I actively engage in developing <br className="2xl:block hidden"/>
        and designing immersive <span className="text-AAsecondary">MERN applications</span>. This involves working with{" "}
        <span className="text-AAsecondary">NodeJs, ReactJs, ExpressJs</span>and {" "}
